...
def main():
    ...
    parser.add_argument('-emb_file_enc', type=str, default='data/glove.6B.300d.txt',
                        help="source Embeddings from this file")
    parser.add_argument('-emb_file_dec', type=str, default='data/glove.6B.300d.txt',
                        help="target Embeddings from this file")
    parser.add_argument('-output_file', type=str, default='data/LSMDC-E/embedding/embedding',
                        help="Output file for the prepared data")
    parser.add_argument('-dict_file', type=str, default='data/LSMDC-E/data_res.json',
